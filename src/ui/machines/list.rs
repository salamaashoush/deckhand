        ...
        let item_content = h_flex()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .justify_center()
                    .child(Icon::new(IconName::Frame).text_color(gpui::rgb(0xffffff))),
            )
            .child(
                v_flex()
                    .flex_1()
                            ...
                            .dropdown_menu(move |menu, _window, _cx| {
                                ...
                                if running {
                                    menu = menu
                                        ...
                                        .separator()
                                        .item(PopupMenuItem::new("Terminal").icon(IconName::SquareTerminal))
                                        .item(PopupMenuItem::new("Files").icon(IconName::Folder));
                                } else {
                                    menu = menu.item(
        ...
        v_flex()
            ...
            .child(
                div()
                    ...
                    .items_center()
                    .justify_center()
                    .child(Icon::new(IconName::Frame).text_color(colors.muted_foreground)),
            )
            .child(
                div()
                    .text_xl()
